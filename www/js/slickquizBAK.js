...
// For convenience...
		...
		/* start Added by RN to get date now */
		var today = Date.now();
         	today = new Date();

     	localStorage.setItem('mylocaltime', today);
		/* end Added by RN to get date now */
                        ...
                        if (questions.hasOwnProperty(i)) {
                           ...
                           //  questionHTML.append('<span class="daterange">'+ question.date_published +' - '+ question.date_expire +'</span>');
                            ...
                            if (!plugin.config.disableResponseMessaging) {
                                ...
                                responseHTML.append('<li><div class="date">' + question.date_published + '</div></li>');
                                responseHTML.append('<li><input id="datePublished" type="hidden" value="' + question.date_published + '"/></li>');
                                responseHTML.append('<li><input id="dateExpire" type="hidden" value="' + question.date_expire + '"/></li>');
                                // $('#date_published').text(question.date_published);
                                responseHTML.append('<li><div class="answerResult correct animated fadeInBottomBig options fast">' +
                            ...
                            if (plugin.config.disableResponseMessaging || plugin.config.completionResponseMessaging) {
                                ...
                                questionHTML.append('<a href="#" class="button nextQuestion hidden">' + plugin.config.nextQuestionText + '</a>');
